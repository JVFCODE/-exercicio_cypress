...
describe('Testes de Crud Contatos', () => {
    ...
    it('deve incluir um novo contato', () => {
        cy.get('[type="text"]').type('Diego Pazzini')
        cy.get('[type="email"]').type('diegopazzini2009@hotmail.com')
        cy.get('[type="tel"]').type('51 995135379')
    ...
    it('deve alterar o primeiro contato selecionado', () => {
        ...
        cy.get('[type="email"]').type('jdiegopazzini2009@hotmail.com')
        //Altera telefone
